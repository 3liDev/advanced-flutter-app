...
import 'package:advanced_flutter_app/presentation/main/pages/home/viewmodel/home_viewmodel.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _getServicesWidget(List<Service>? services) {
    if (services != null) {
      return Padding(
        padding: EdgeInsets.only(left: AppPadding.p8W, right: AppPadding.p8W),
        child: Container(
          height: AppSize.s150H,
          margin: EdgeInsets.symmetric(vertical: AppMargin.m8H),
          child: ListView(
            ...
            children: services
                .map((service) => Card(
                      ...
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(AppSize.s12R),
                          side: BorderSide(
                              color: ColorManager.white, width: AppSize.s1SP)),
  ...
  Widget _getStoresWidget(List<Store>? stores) {
    if (stores != null) {
      return Padding(
        padding: EdgeInsets.only(
            left: AppPadding.p8W, right: AppPadding.p8W, top: AppPadding.p8H),
        child: Flex(
          direction: Axis.vertical,
          children: [
            GridView.count(
                crossAxisCount: AppSize.s2,
                crossAxisSpacing: AppSize.s4SP,
                mainAxisSpacing: AppSize.s4SP,
